...
public final class PvmRecompiler implements AutoCloseable {
    ...
    /**
     * Execute a block over a 13-register file and a gas budget.
     * {@code regs} is read and written in place (length 13). Returns
     * {@code {exitCode, gasRemaining}} and mutates {@code regs}.
     */
    public long[] execute(Block block, long[] regs, long gas) {
        ...
        try (Arena call = Arena.ofConfined()) {
            ...
            int exit = (int) execute.invoke(block.handle, regSeg, gasSeg);
