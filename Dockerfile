...
ENV LOG_LEVEL=ERROR
ENV JAVA_OPTS="-XX:+UseG1GC -Xms2g -Xmx4g -XX:+AlwaysPreTouch -XX:+UseStringDeduplication -XX:CRaCAllowedOpenFilePrefixes=/proc/,/sys/,/dev/ -Dlogback.configurationFile=/app/logback.xml"
